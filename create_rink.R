...
# Source: http://blog.war-on-ice.com/make-your-own-nhl-rink-plot-in-r/index.html
# source: https://github.com/jamesmartherus/shotplot

# Have a function that plots either half a rink or the full rink
