...
ui <- secure_app(head_auth = tags$script(inactivity),
    ...
    dashboardBody(
        ...
        tabItem(tabName = "about",
                flipBox(
                    id = 1,
                    main_img = "https://github.com/zizekw/MMA-datathon-may2020/blob/master/images/rotman-icon.png?raw=true",
                    header_img = "https://github.com/zizekw/MMA-datathon-may2020/blob/master/images/rotman-banner.jpg?raw=true",
                ...
                widgetUserBox(
                    ...
                    tags$a(href="https://www.linkedin.com/in/maggiehu123/", "LinkedIn"),
                ...
                widgetUserBox(
                    ...
                    color = "gray",
                    tags$a(href="https://www.linkedin.com/in/gracelou/", "LinkedIn"),
                    # footer = "The footer here!",
                    collapsible = FALSE
                ),
                widgetUserBox(
                    ...
                    color = "gray",
                    tags$a(href="https://www.linkedin.com/in/keqing-shirley-zhang/", "LinkedIn"),
                    # footer = "The footer here!",
                    collapsible = FALSE
                ),
                widgetUserBox(
                    ...
                    color = "gray",
                    tags$a(href="https://www.linkedin.com/in/bzizek/", "LinkedIn"),
                    # footer = "The footer here!",
                    collapsible = FALSE
                )
        ),
        ...
        tabItem(tabName = "recs", 
                ...
                fluidRow(width = 12,
                                ...
                                widgetUserBox(
                                    ...
                                    color = "gray",
                                    "Brianne the top faceoff and takeaway specialist. She also has an exceptional passing percentage to top scorers as well as the team in general.",
                                    # footer = "foo",
                                    collapsible = FALSE
                                ),
                                widgetUserBox(
